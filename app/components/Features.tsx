...
export default function Features() {
  ...
  return (
    <div className="bg-[#FAF8F5] text-stone-900 relative z-20 font-sans">
      ...
      <section id="offer" className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto -mt-6">
        <div className="rounded-3xl bg-gradient-to-br from-emerald-950 via-emerald-900 to-stone-900 text-white p-8 md:p-12 shadow-2xl relative overflow-hidden border border-emerald-800/40">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-7 space-y-5">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-400 text-stone-950 text-xs font-bold uppercase tracking-wider shadow-sm">
                <Tag className="w-3.5 h-3.5" />
                <span>Limited Event Only Pricing</span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-light font-serif text-white tracking-tight">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 text-xs text-amber-200">
                  <Calendar className="w-4 h-4 text-amber-300" />
                  <span>Sunday, 11 October 2026</span>
                </div>
                <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 text-xs text-stone-200">
              ...
              <div className="pt-2 flex flex-col items-start gap-2">
                <a
                  href="#event-pass"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-amber-400 hover:bg-amber-300 text-stone-950 text-sm sm:text-base font-bold tracking-wide shadow-xl transition-all duration-200 hover:scale-105 active:scale-95 text-center whitespace-nowrap"
                >
            ...
            <div className="lg:col-span-5 flex items-center justify-center">
              <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden border border-white/20 shadow-2xl group">
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-xs text-white">
                  <span className="px-2.5 py-1 rounded-md bg-black/60 backdrop-blur-md border border-white/20 font-medium">
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="text-3xl sm:text-5xl font-light font-serif text-stone-900 leading-tight">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-stone-200">
              <div className="p-4 rounded-2xl bg-white border border-stone-200 shadow-sm text-center">
                <p className="text-2xl sm:text-3xl font-serif text-emerald-900 font-normal">600+</p>
                <p className="text-[10px] sm:text-xs text-stone-500 font-semibold uppercase tracking-wider mt-1">Acres Township</p>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-stone-200 shadow-sm text-center">
                <p className="text-2xl sm:text-3xl font-serif text-amber-700 font-normal">50%</p>
                <p className="text-[10px] sm:text-xs text-stone-500 font-semibold uppercase tracking-wider mt-1">Launch Offer*</p>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-stone-200 shadow-sm text-center">
                <p className="text-2xl sm:text-3xl font-serif text-emerald-900 font-normal">500–1k</p>
                <p className="text-[10px] sm:text-xs text-stone-500 font-semibold uppercase tracking-wider mt-1">Sq. Yards on Offer</p>
              </div>
            </div>
          </div>
      ...
      <section id="plots" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-stone-200">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-light font-serif text-stone-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {plotOptions.map((plot, i) => (
            <div
              key={i}
              className={`rounded-3xl p-8 transition-all duration-300 flex flex-col justify-between relative bg-white border ${plot.popular
                ? "border-emerald-800 shadow-xl ring-2 ring-emerald-800/20"
                : "border-stone-200 shadow-sm hover:shadow-lg hover:border-stone-300"
                }`}
            >
              {plot.popular && (
                <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-emerald-900 text-amber-300 text-[11px] font-bold uppercase tracking-wider shadow-md">
              ...
              <div>
                ...
                <h3 className="text-3xl font-normal font-serif text-stone-900">{plot.size}</h3>
                <p className="text-xs text-stone-500 font-mono mt-1">{plot.approx}</p>
                <p className="text-sm font-medium text-emerald-950 mt-3">{plot.idealFor}</p>
              ...
              <div className="mt-8 pt-6 border-t border-stone-100">
                <a
                  href="#event-pass"
                  className={`inline-flex items-center justify-center gap-2 w-full py-3.5 rounded-xl text-xs font-semibold tracking-wide transition-all ${plot.popular
      ...
      <section id="event-pass" className="w-full py-16 md:py-24 bg-[#FAF8F5] border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
            {/* Left Content Card with form-bgimage.png strictly as its background */}
            <div className="lg:col-span-7 relative rounded-[32px] overflow-hidden p-8 sm:p-10 lg:p-12 flex flex-col justify-between border border-stone-200/90 shadow-2xl min-h-[580px]">
              ...
              <div className="relative z-10 space-y-5">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400 text-stone-950 text-xs font-bold uppercase tracking-wider shadow-md">
                  <Calendar className="w-3.5 h-3.5 text-stone-950" />
                  <span>PHYSICAL EVENT PASS</span>
                </div>

                <h2 className="text-3xl sm:text-5xl lg:text-5xl font-light font-serif text-white leading-[1.14] tracking-tight">
                  Secure Your <br />
                  <span className="font-normal text-amber-300 font-serif italic">50% OFF*</span> <br />
                  Event Invitation
                </h2>

                <p className="text-stone-200 text-sm sm:text-base leading-relaxed max-w-lg font-light">
                  Entry to the exclusive price launch at Holiday Inn, Delhi is by prior registration only. Register your details to receive your personalized digital event pass and pre-event pricing catalogue.
                </p>

                {/* Event Details Cards */}
                <div className="space-y-3 pt-2 max-w-lg">
                  <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/15 backdrop-blur-md border border-white/20 shadow-sm text-white">
                    <div className="w-10 h-10 rounded-xl bg-amber-400 text-stone-950 flex items-center justify-center shrink-0 shadow">
                      <Calendar className="w-5 h-5" />
                    </div>
                    <div>
                      <p className="text-xs font-bold text-white">Sunday, 11 October 2026</p>
                      <p className="text-[11px] text-stone-300">11:00 AM onwards (Slot allocation on confirmation)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/15 backdrop-blur-md border border-white/20 shadow-sm text-white">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-stone-300">Grand Ballroom &bull; Dedicated Valet Parking Available</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-wrap items-center gap-5 pt-6 border-t border-white/15 text-xs font-medium text-stone-200">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center">
              <div className="rounded-3xl bg-white/95 backdrop-blur-xl border border-stone-200/90 shadow-2xl p-6 sm:p-8">
                {submitted ? (
                  <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
                    <div className="w-14 h-14 rounded-full bg-emerald-900 text-amber-200 flex items-center justify-center shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-stone-50/80 border border-stone-200 text-sm text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-emerald-850 focus:border-emerald-800"
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-stone-50/80 border border-stone-200 text-sm text-stone-900 focus:outline-none focus:ring-2 focus:ring-emerald-850 focus:border-emerald-800 cursor-pointer"
                        >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {[
                            ...
                            <button
                              ...
                              className={`py-2.5 px-3 rounded-xl text-xs font-medium border transition-all flex items-center justify-center gap-1.5 ${formData.preferredTime === slot
                      ...
                      <button
                        type="submit"
                        className="w-full py-4 rounded-xl bg-emerald-900 hover:bg-emerald-950 text-amber-200 text-sm font-bold tracking-wide shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] mt-2 flex items-center justify-center gap-2"
                      >
      ...
      {/* LOCATION & DISTANCES */}
      <section id="location" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-stone-200">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl bg-white border border-stone-200">
            <h4 className="text-base font-serif font-semibold text-stone-900 mb-1">Jim Corbett Safari Gates</h4>
            <p className="text-xs text-stone-500 mb-3">Bijrani, Dhela &amp; Jhirna Safari Zones</p>
            <p className="text-2xl font-serif text-emerald-900">15 – 25 Mins</p>
          </div>
          <div className="p-6 rounded-2xl bg-white border border-stone-200">
            <h4 className="text-base font-serif font-semibold text-stone-900 mb-1">Ramnagar Railway Station</h4>
            <p className="text-xs text-stone-500 mb-3">Direct connectivity with Delhi NCR trains</p>
            <p className="text-2xl font-serif text-emerald-900">20 Mins</p>
          </div>
          <div className="p-6 rounded-2xl bg-white border border-stone-200">
            <h4 className="text-base font-serif font-semibold text-stone-900 mb-1">Delhi NCR Highway Drive</h4>
            <p className="text-xs text-stone-500 mb-3">Via Delhi-Meerut Expressway &amp; Moradabad Bypass</p>
            <p className="text-2xl font-serif text-emerald-900">4.5 Hours</p>
          </div>
        </div>
      </section>

      {/* FOOTER */}
      <footer className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-stone-200/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-stone-500">
        <div className="flex items-center gap-2">
